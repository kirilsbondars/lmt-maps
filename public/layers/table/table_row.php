<tr id="<?php echo $id?>">
    ...
    <td class="forth">
        <div class="btn-group" role="group">
            ...
            <a href="files/download_file_id.php?id=<?php echo $id?>" class="btn btn-secondary actions download" title="Download layer" role="button" aria-pressed="true"><i class="fa fa-download" aria-hidden="true"></i></a>
